                ...
                if !isSearching {
                    ...
                    case .history:
                        if allHistoryEntries.isEmpty {
                            EmptyInstructionView(title: "No History", message: "Start watching to build history", systemName: "clock.arrow.circlepath")
                        }
                    case .debridCloud:
                        if debridManager.selectedDebridSource == nil {
                            EmptyInstructionView(title: "Cloud Unavailable", message: "Listing is not available for this service", systemName: "icloud.slash")
                        }
                    }
                }
            }
